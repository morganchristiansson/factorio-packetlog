...
REAL_PACKET_FIXTURES = [
  ...
  },
  {
    ...
    actions: [
      { type: 106, name: 'write_to_console', game_player: 12,
  ...
  },
  {
    ...
    actions: [
      { type: 84, name: 'server_tick_info', game_player: 1,
        data: '64ad0dd5e834b20000000000' },
      { type: 106, name: 'write_to_console', game_player: 6,
  ...
  },
  {
    ...
    actions: [
      ...
      { type: 68, name: 'build', game_player: 58,
  ...
  },
  {
    ...
    actions: [
      ...
      { type: 131, name: 'deconstruct', game_player: 6,
  ...
  },
  {
    ...
    actions: [
      ...
      { type: 69, name: 'start_walking', game_player: 58,
  ...
  },
  {
    ...
    actions: [
      ...
      { type: 90, name: 'pipette', game_player: 6,
  ...
  },
  {
    ...
    actions: [
      ...
      { type: 79, name: 'cursor_split', game_player: 6,
        data: '3200010000' },
    ],
  },
  {
    ...
    actions: [
      ...
      { type: 78, name: 'cursor_transfer', game_player: 6,
  ...
  },
  {
    ...
    actions: [
      ...
      { type: 1, name: 'stop_walking', game_player: 59, data: '' },
    ],
  },
  {
    ...
    actions: [
      ...
      { type: 133, name: 'copy', game_player: 42, data: '' },
    ],
  },
  {
    ...
    actions: [
      ...
      { type: 132, name: 'upgrade', game_player: 42, data: '' },
    ],
  },
  {
    ...
    actions: [
      ...
      { type: 279, name: 'fast_entity_transfer', game_player: 37,
        data: '01' },
    ],
  },
  {
    ...
    actions: [
      ...
      { type: 83, name: 'inventory_transfer', game_player: 58,
        data: '0000000000' },
    ],
  },
  {
    ...
    actions: [
      ...
      { type: 5, name: 'open_gui', game_player: 6,
  ...
  },
  {
    ...
    actions: [
      { type: 5, name: 'open_gui', game_player: 1,
  ...
  },
  {
    ...
    actions: [
      { type: 9, name: 'selected_entity_cleared', game_player: 12,
  ...
  },
  {
    ...
    actions: [
      { type: 1, name: 'stop_walking', game_player: 12, data: '' },
    ],
  },
  {
    name: 'client_pipette',
    ...
    actions: [
      { type: 90, name: 'pipette', game_player: 12,
  ...
  },
  {
    ...
    actions: [
      { type: 124, name: 'use_item', game_player: 12,
  ...
  },
  {
    ...
    actions: [
      { type: 71, name: 'change_riding_state', game_player: 12,
        data: '0100' },
    ],
  },
  {
...

  {
    ...
    actions: [
      { type: 128, name: 'zoom_around_point', game_player: 1,
  ...
  },
  {
    ...
    actions: [
      { type: 266, name: 'selected_entity_changed_very_close', game_player: 1,
        data: '84' },
      { type: 69, name: 'start_walking', game_player: 1,
  ...
  },
  {
    ...
    actions: [
      { type: 9, name: 'selected_entity_cleared', game_player: 1,
        data: '' },
      { type: 69, name: 'start_walking', game_player: 1,
  ...
  },
  {
    ...
    actions: [
      { type: 68, name: 'build', game_player: 2,
        data: '80fbffff8002000000010180fbffff800400000010' },
      { type: 9, name: 'selected_entity_cleared', game_player: 2,
  ...
  },
  {
    ...
    actions: [
      { type: 61, name: 'open_character_gui', game_player: 2, data: '01' },
      { type: 266, name: 'selected_entity_changed_very_close', game_player: 2, data: '8a' },
      { type: 266, name: 'selected_entity_changed_very_close', game_player: 2, data: '88' },
      { type: 266, name: 'selected_entity_changed_very_close', game_player: 2, data: '77' },
      { type: 266, name: 'selected_entity_changed_very_close', game_player: 2, data: '88' },
      { type: 266, name: 'selected_entity_changed_very_close', game_player: 2, data: '78' },
      { type: 266, name: 'selected_entity_changed_very_close', game_player: 2, data: '78' },
      { type: 266, name: 'selected_entity_changed_very_close', game_player: 2, data: '68' },
      { type: 266, name: 'selected_entity_changed_very_close', game_player: 2, data: '67' },
      { type: 266, name: 'selected_entity_changed_very_close', game_player: 2, data: '78' },
      { type: 266, name: 'selected_entity_changed_very_close', game_player: 2, data: '78' },
      { type: 266, name: 'selected_entity_changed_very_close', game_player: 2, data: '78' },
      { type: 266, name: 'selected_entity_changed_very_close', game_player: 2, data: '88' },
      ...
      { type: 266, name: 'selected_entity_changed_very_close', game_player: 2, data: '88' },
      { type: 266, name: 'selected_entity_changed_very_close', game_player: 2, data: '88' },
      { type: 266, name: 'selected_entity_changed_very_close', game_player: 2, data: '88ed64000000000000' },
    ],
  },
  {
    ...
    actions: [
      { type: 266, name: 'selected_entity_changed_very_close', game_player: 2, data: 'b1' },
      { type: 266, name: 'selected_entity_changed_very_close', game_player: 2, data: '88' },
      { type: 266, name: 'selected_entity_changed_very_close', game_player: 2, data: '88' },
      { type: 266, name: 'selected_entity_changed_very_close', game_player: 2, data: '88' },
      { type: 266, name: 'selected_entity_changed_very_close', game_player: 2, data: '88' },
      ...
      { type: 266, name: 'selected_entity_changed_very_close', game_player: 2, data: '88' },
      { type: 266, name: 'selected_entity_changed_very_close', game_player: 2, data: '88' },
      { type: 69, name: 'start_walking', game_player: 2,
        data: 'cc3b7f669ea0e63fcc3b7f669ea0e6bf' },
      { type: 266, name: 'selected_entity_changed_very_close', game_player: 2, data: '88' },
      { type: 69, name: 'start_walking', game_player: 2,
        data: 'cc3b7f669ea0e63fcc3b7f669ea0e6bf' },
  ...
  # messages mid-word).
  {
    ...
    actions: [
      { type: 104, name: 'write_to_console', game_player: 67,
